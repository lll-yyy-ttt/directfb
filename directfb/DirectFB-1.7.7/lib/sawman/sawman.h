...
typedef enum {
     ...
     SWMCF_NAME          = DWCONF_NAME,
     SWMCF_HIDE          = DWCONF_HIDE,
...
typedef struct {
     char                     name[DFB_WINDOW_NAME_MAX_LENGTH];
     DFBBoolean               hide;
...
typedef struct {
     ...
     DirectResult (*WindowClose)    ( void               *context,
                                      SaWManWindowInfo   *info );
     DirectResult (*WindowMin)      ( void               *context,
                                      SaWManWindowInfo   *info );
     DirectResult (*WindowMax)      ( void               *context,
                                      SaWManWindowInfo   *info );
...
DEFINE_INTERFACE(   ISaWManManager,
   ...
   /** Windows **/
     ...
     /*
      * maximization or recover a window.
      */
     DirectResult (*SetMaximization) (
          ISaWManManager           *thiz,
          SaWManWindowHandle        handle,
          DFBBoolean                recover
     );
   ...
   /** Locking **/
     ...
     /*
      * Get hide of a window.
      */
     DirectResult (*GetHide) ( 
          ISaWManManager     *thiz,
          SaWManWindowHandle  handle,
          DFBBoolean         *ret_hide 
     );
     ...
     /*
      * Get maximization of a window.
      */
     DirectResult (*GetMaximization) ( 
          ISaWManManager     *thiz,
          SaWManWindowHandle  handle,
          DFBBoolean         *ret_max 
     );
     ...
     /*
      * RaiseToTop of a window.
      */
     DirectResult (*RaiseToTop)( 
          ISaWManManager     *thiz,
          SaWManWindowHandle  handle 
     );
)
