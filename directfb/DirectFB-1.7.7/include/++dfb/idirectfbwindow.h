...
public:
     ...
     void                  PPDFB_API SetName           (const char             *name);
     void                  PPDFB_API GetName           (char                   *buffer,
                                                        int		        len);

     void                  PPDFB_API SetHide           (DFBBoolean              hide);
     void                  PPDFB_API GetHide           (DFBBoolean             *hide);

     void                  PPDFB_API ScreenToClient    (int                    *x,
                                                        int                    *y);
